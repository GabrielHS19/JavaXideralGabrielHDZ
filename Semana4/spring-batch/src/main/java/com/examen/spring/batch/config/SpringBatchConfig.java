...
import com.examen.spring.batch.repository.ClienteRepository;
...
public class SpringBatchConfig {
    ...
    private LineMapper<Cliente> lineMapper() {
        ...
        lineTokenizer.setNames("id", "nombre", "apellido", "email", "genero", "numeroTelefonico", "pais", "fechaNacimiento");
